...
<div id="wrapper">
    ...
    <form action="" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-item">
            <label class="item-label">菜谱名称</label>
            <div class="controls">
                <input type="text" class="text input-large" readonly value="<?php echo ($data['foodname']); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">菜谱图片</label>
            <div class="controls">
                <img src="/menu/Uploads<?php echo ($data['foodurl']); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">菜谱介绍</label>
            <div class="controls">
                <textarea class="textarea input-large" name="menu"><?php echo ($data['foodintroduce']); ?></textarea>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">菜系</label>
            <div class="controls">
                <input type="text" class="text input-large" readonly value="<?php echo ($data['name']); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">菜谱价格</label>
            <div class="controls">
                <input type="text" class="text input-large" readonly value="<?php echo ($data['foodprice']); ?>">
            </div>
        </div>
