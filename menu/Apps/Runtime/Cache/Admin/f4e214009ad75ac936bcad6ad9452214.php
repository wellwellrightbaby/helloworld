...
<script src="/menu/Public/Admin/Bootstrap/js/bootstrap-table-zh-CN.js" type="text/javascript" ></script>
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <table id="table" data-toggle="table"
                ...
                <tbody>
                <?php if(is_array($book)): $i = 0; $__LIST__ = $book;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($arr["bookid"]); ?></td>
                        <td><?php echo ($arr["swid"]); ?></td>
                        <td><?php echo ($arr["username"]); ?></td>
                        <td><?php echo ($arr["usertelephone"]); ?></td>
                        <td><?php echo ($arr["foodname"]); ?></td>
                        <td><?php echo ($arr["bjlxname"]); ?></td>
                        <td><?php echo ($arr["booktime"]); ?></td>
                        <td>
                            <a class="btn btn-sm btn-success" href="<?php echo U('detail',array('SwId'=>$arr['swid']));?>">
    ...
    $(function () {
        $('#btn_del').click(function (event) {
            ...
            $.ajax({
                type: "post",
                url: "/menu/index.php/Admin/Order/del",
                data: {BookId: id},
                dataType: 'text',
