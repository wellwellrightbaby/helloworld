...
<script src="/menu/Public/Admin/Bootstrap/js/bootstrap-table-zh-CN.js" type="text/javascript" ></script>
        ...
        <div class="panel-body">
            <div id="toolbar">
                <div class="btn btn-primary">
                    <span class="" aria-hidden="true"></span>购物车</div>
            </div>
            <!--表格start-->
            <table id="table" data-toggle="table"
                ...
                <tr>
                    ...
                    <th data-field="5">添加时间</th>
                    <th data-field="6">操作</th>
                </tr>
                </thead>
                <tbody>
                <?php if(is_array($shop)): $i = 0; $__LIST__ = $shop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($arr["shopid"]); ?></td>
                        <td><?php echo ($arr["username"]); ?></td>
                        <td><?php echo ($arr["usertelephone"]); ?></td>
                        <td><?php echo ($arr["foodname"]); ?></td>
                        <td><?php echo ($arr["foodprice"]); ?></td>
                        <td><?php echo ($arr["foodupdatetime"]); ?></td>
                        <td>
                            <a class="btn btn-sm btn-success" href="<?php echo U('detail',array('ShopId'=>$arr['shopid']));?>">
    ...
    $(function () {
        $('#btn_del').click(function (event) {
            ...
            $.ajax({
                type: "post",
                url: "/menu/index.php/Admin/Shopping/del",
                data: {ShopId: id},
                dataType: 'text',
