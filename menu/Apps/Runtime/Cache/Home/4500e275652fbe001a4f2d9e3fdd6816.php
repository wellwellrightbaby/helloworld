...
<body>
    ...
    <div class="header">
        ...
        <ul class="nav_zone">
            ...
            <li>
                <a href="/menu/index.php/Home/OnesMenu">个性菜谱</a>
                <div class="down">
                    <a href="#">我的收藏菜谱</a>
                    <a href="#">我的收藏包间</a>
                </div>
...
<footer>
    <div class="f_footer">
        ...
        <p class="f_p2"><img src="img/foot/1.png" /> 苏公网安备 32011402010009号 | 苏ICP备09062682号-9 | 增值电信业务经营许可证：苏B2-20130048 | 网络文化经营许可证：苏网文[2015] 1599-026号</font></p>
