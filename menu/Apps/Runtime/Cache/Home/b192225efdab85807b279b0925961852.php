...
<body>
    ...
    <body>
    <div class="header">
        <a href="#" class="logo">我是logo</a>
        hello  !    <font style="color:blue;"> <?php echo $_SESSION['username'] ?>    </font>
        ...
        <ul class="nav_zone">
            ...
            <li>
                ...
                <div class="down">
                    ...
                    <a href="<?php echo U('Shop/myorder');?>">我的订单</a>
                </div>
            </li>
...
<div class="aboutus">
    我们是dreamhigh组合啦啦啦<img src="/menu/Public/Home/Img/AboutUs/ha.jpg" alt="">
</div>
...
<footer>
    <div class="f_footer">
        ...
        <p class="f_p2"> 联系电话：13160678112/13160661309</font>  <a href="<?php echo U('AboutUs/Index');?>"><font style="color:blue">关于我们</font></a></p>
