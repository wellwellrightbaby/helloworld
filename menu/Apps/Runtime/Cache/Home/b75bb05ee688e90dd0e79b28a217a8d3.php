...
<div class="onesmenu">
        ...
        <table style="text-align: center;" class="page">
            <tr>
            <br>
                <th>选择</th>
        ...
        <form action="<?php echo U('Shop/jiesuanmore');?>">

            <?php if(is_array($cart1)): $i = 0; $__LIST__ = $cart1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cart1): $mod = ($i % 2 );++$i;?><tr  class="menu_list">
                    <td><input type="checkbox" value="<?php echo ($cart1["foodid"]); ?>" name='idid[]'></td>
                    <td><a href="<?php echo U('Xiangqingshow/index',array('showid'=>$cart1['foodid']));?>"><img src="<?php echo ($cart1["foodurl"]); ?>" alt="" class="menu_img"></a></td>
                    <td><a href="<?php echo U('Xiangqingshow/index',array('showid'=>$cart1['foodid']));?>"><?php echo ($cart1["foodname"]); ?></a></td>
                    <td><?php echo ($cart1["foodintroduce"]); ?></td>
                    <td><?php echo ($cart1["foodprice"]); ?></td>
                    <td><button class="menu_button menu_button1"><a href="<?php echo U('Shop/jiesuan',array('id1'=>$cart1['foodid']));?>">结算</a>
                    </button>
                    <button class="menu_button menu_button2"><a href="<?php echo U('Shop/deletecartitem',array('id'=>$cart1['foodid']));?>">删除</a></button></td>
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="table-fun"><!-- 
                                ...
                                <!-- <button class="menu_button menu_button2"><a href="<?php echo U('Shop/deletemore');?>"></a>批量删除</button> -->
                                <button class="menu_button menu_button2" type="submit">批量结算</button>
                            </div>
                        </td>
                    </tr>
            </form>
