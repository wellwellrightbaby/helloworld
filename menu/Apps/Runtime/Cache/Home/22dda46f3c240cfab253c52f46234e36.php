...
<h1>我的个性菜谱</h1>
    <div class="onesmenu">
        ...
        <table style="text-align: center;" class="page">
            ...
            <?php if(is_array($fss)): $i = 0; $__LIST__ = $fss;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$io): $mod = ($i % 2 );++$i;?><tr  class="menu_list">
                    <td><a href="<?php echo U('Xiangqingshow/index',array('showid'=>$io['foodid']));?>"><img src="<?php echo ($io["foodurl"]); ?>" alt="" class="menu_img"></a></td>
                    <td><a href="<?php echo U('Xiangqingshow/index',array('showid'=>$io['foodid']));?>"><?php echo ($io["foodname"]); ?></a></td>
                    <td><?php echo ($io["foodintroduce"]); ?></td><td><?php echo ($io["foodprice"]); ?></td>
                    <td><button class="menu_button menu_button1" ><a href="<?php echo U('Shop/joincart',array('id'=>$io['foodid']));?>">加入购物车</a></button><button class="menu_button menu_button2"><a href="<?php echo U('Shop/deletesaveitem',array('saveid'=>$io['foodid']));?>">删除</a></button></td>
