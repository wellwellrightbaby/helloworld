...
<div class="roombook">
    ...
    <table style="text-align: center;" class="page">
        ...
        <?php if(is_array($bookroom1)): $i = 0; $__LIST__ = $bookroom1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bk): $mod = ($i % 2 );++$i;?><tr  class="menu_list" id="">
                <td><img src="<?php echo ($bk['bjlxurl']); ?>" alt="<?php echo ($bk["bjlxname"]); ?>" class="roombook_img"></td>
                <td><?php echo ($bk["bjlxname"]); ?></td>
                <td><?php echo ($bk["bjlxsize"]); ?>人</td>
                <td><?php echo ($bk["bjlxcount"]); ?></td>
                <td><button class="menu_button menu_button1"><a href="<?php echo U('RoomBook/bookroom',array('id'=>$bk['bjlxid']));?>">预定</a></button></td>
